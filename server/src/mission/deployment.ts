...
import type { Vec2, DeploymentZone } from '@legionaires/shared';
...
export class DeploymentManager {
   ...
   */
  generateZone(mapWidth: number, mapHeight: number, playerCount: number): DeploymentZone {
  ...
  private isPositionOccupied(pos: Vec2, minDist = 15): boolean {
