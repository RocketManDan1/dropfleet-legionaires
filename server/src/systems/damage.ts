...
function rollToHit(shot: ShotRecord, units: Map<string, UnitInstance>): ToHitResult {
...
function rollPenetration(shot: ShotRecord, target: UnitInstance, facing: ArmourFacing): PenResult {
...
function rollCrewDamage(_shot: ShotRecord, target: UnitInstance): number {
...
function rollSystemDamage(_shot: ShotRecord, _target: UnitInstance): SystemDamage[] {
