...
// ============================================================================
import { SP_MINIMUM_FLOOR, SP_DIFFICULTY_MULTIPLIERS, SP_BONUS_ZERO_KIA, SP_BONUS_SECONDARY, SP_BONUS_SPEED, SP_BASE_TABLE, SP_MIN_COMBAT_TIME_SEC, } from '@legionaires/shared/constants';
/**
 ...
 */
export function calculateCrewReplacementCost(unitFullCost, crewMax, crewToRestore) {
    if (crewMax <= 0)
        return 0;
 ...
 */
export function calculateSPReward(missionType, difficulty, outcome, bonuses, participationPct) {
 ...
 */
export function calculateAllPlayerRewards(missionType, difficulty, outcome, players) {
