...
// ============================================================================
import { PLATOON_SIZES, } from '@legionaires/shared/constants';
// ---------------------------------------------------------------------------
// Constants
// ---------------------------------------------------------------------------
/**
...
export class MissionGenerator {
     ...
     */
    generateEnemyForce(faction, profile) {
     ...
     */
    selectQuality(weights) {
        const roll = Math.random();
        if (roll < weights.baseline)
            return 'baseline';
        if (roll < weights.baseline + weights.veteran)
            return 'veteran';
        return 'elite';
    }
    // -----------------------------------------------------------------------
     ...
     */
    generateObjectives(missionType, profile) {
        const objectives = [];
     ...
     */
    generatePrimaryObjective(missionType) {
     ...
     */
    generateSecondaryObjective(missionType, index) {
     ...
     */
    generateMapSeed(planet, missionType) {
