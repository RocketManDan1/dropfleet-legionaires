...
export class DeploymentManager {
     ...
     */
    generateZone(mapWidth, mapHeight, playerCount, missionType, objectiveCenter, terrainTypeMap, heightmap, seaLevel) {
    ...
    isPositionOccupied(pos, minDist = MIN_UNIT_SPACING) {
...
function isTerrainValid(x, z, mapWidth, terrainTypeMap, heightmap, seaLevel) {
    ...
    if (terrainTypeMap && idx < terrainTypeMap.length) {
        if (INVALID_DEPLOY_TERRAIN.has(terrainTypeMap[idx]))
            return false;
    }
