...
export function stageSeed(masterSeed, stage) {
...
export function resolveBatlocConfig(presetName, overrides) {
    ...
    const roadCodes = [0, 1, 2, 3, 4, 5, 255];
    ...
    const terrainMods = [0, 1, 2, 3, 4, 5, 6, 7];
    ...
    const seasons = ['summer', 'winter', 'desert'];
