 ...
 */
function worldToCell(worldX, worldZ, cellSizeM) {
    return [
 ...
 */
function gaussianValue(distSq, twoSigmaSq, intensity) {
 ...
 */
function threatLevelForUnit(unit) {
...
export class InfluenceMapManager {
    ...
    controlGrid;
    constructor(mapWidthM, mapHeightM, cellSizeM = SPATIAL_HASH_CELL_SIZE) {
     ...
     * not total grid size.
     */
    stampKernel(grid, cx, cz, radiusCells, twoSigmaSq, intensity) {
     ...
     */
    findLowestThreatNeighbour(origin) {
