...
const ZERO_AMMO = { he: 0, ap: 0, heat: 0, sabot: 0 };
const FULL_AMMO = { he: 20, ap: 20, heat: 0, sabot: 0 };
// ---------------------------------------------------------------------------
 ...
 */
export function makeDetectedContact(targetId, posX, posZ) {
    return {
 ...
 */
export function makeUnitType(overrides) {
    return {
        name: 'Test Unit',
 ...
 */
export function makeFlatTerrain(width, height) {
