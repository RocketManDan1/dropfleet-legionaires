...
function generateTownAnchors(width, height, seaLevel, heightmap, slopeMap, wetnessMap, coverMap, seed) {
...
function buildObjectives(width, height, towns, bridges, fords, heightmap) {
    const out = [];
...
export function generateTerrain(width = 400, height = 400, seedOrOptions) {
    ...
    const towns = generateTownAnchors(width, height, seaLevel, heightmap, slopeMap, wetnessMap, coverMap, baseSeed);
